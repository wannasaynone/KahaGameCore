using System;
using KahaGameCore.Effects.Processor;
...
namespace KahaGameCore.Tests
{
    public class ProcesserTest
    {
        ...
        private class TestProcessStep : IProcessable
        {
        ...
        public void Process()
        {
            ...
            Processor<TestProcessStep> processer = new Processor<TestProcessStep>(steps);
            ...
            processer = new Processor<TestProcessStep>(steps);
